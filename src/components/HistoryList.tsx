            ...
            <div className="space-y-6">
                ...
                <div className="p-8 text-center text-slate-500">
                    ...
                    {selectedDate && (
                        <button
                            onClick={onClearDate}
                            className="mb-4 inline-flex items-center gap-1 text-xs text-primary-600 font-medium hover:text-primary-700"
                        >
            ...
            <div className="pb-24 px-6 space-y-6">
                {groupedExpenses.map(group => (
                    <div key={group.date} className="space-y-3">
                        <h3 className="text-xs font-semibold text-slate-600 uppercase tracking-widest pl-1 sticky top-0 bg-background/95 backdrop-blur-md py-2 z-10 w-full flex justify-between items-center group/header">
