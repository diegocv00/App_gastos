            ...
            >
                ...
                <div className="sticky top-0 bg-white/95 backdrop-blur-md border-b border-slate-200 px-6 py-4 flex items-center justify-between rounded-t-3xl">
                    <h2 className="text-xl font-bold text-slate-900">
                        {expense.type === 'income' ? t('edit.editIncome') : t('edit.editExpense')}
                    </h2>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="space-y-6 px-6 pt-6 pb-8">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-medium text-slate-500 uppercase tracking-wider">{t('common.amount')}</label>
                    ...
                    {expense.type !== 'income' && (
                        <div className="space-y-2">
                            <label className="text-xs font-medium text-slate-500 uppercase tracking-wider">{t('common.category')}</label>
                    ...
                    {/* Note Input */}
                    <div className="space-y-2">
                        <label className="text-xs font-medium text-slate-500 uppercase tracking-wider">{t('edit.optionalNote')}</label>
                        <input
                            type="text"
                            value={description}
                            onChange={e => setDescription(e.target.value)}
                            placeholder={expense.type === 'income' ? t('edit.incomeNotePlaceholder') : t('edit.expenseNotePlaceholder')}
